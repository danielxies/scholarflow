...
- Second-order system regressions matter even when the local diff looks clean.
...
- If the change relies on current external facts, require source-backed research memory or block.
